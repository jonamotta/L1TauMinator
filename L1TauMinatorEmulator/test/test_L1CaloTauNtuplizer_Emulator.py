...
process.load('L1Trigger.L1CaloTrigger.l1tNNCaloTauEmulator_cff')
...
process.load('L1TauMinator.L1TauMinatorEmulator.L1CaloTauNtuplizer_Emulator_cff')
...
process.l1tNNCaloTauEmulator.EtMinForSeeding = cms.double(options.minSeedEt)
...
process.tauMinator_path   = cms.Path(process.l1tNNCaloTauEmulator_seq)
process.generator_path    = cms.Path(process.GenHandler_seq)
process.generatorMod_path = cms.Path(process.GenHandlerMenu_seq)
process.ntuplizer_path    = cms.Path(process.L1CaloTauNtuplizerEmulator_seq)
