...
plt.plot(Xs_list[::3], singleTau_offline90Rate_list[::3], lw=3, marker='o', markersize='10', color='#d04e00', label=r'TauMinator', zorder=0)
plt.plot(Xs_list[::3], singleTau_offline90Rate_CB_list[::3], lw=3, marker='s', markersize='10', color='#f6c200', label=r'TauMinator - Barrel', zorder=1)
plt.plot(Xs_list[::3], singleTau_offline90Rate_CE_list[::3], lw=3, marker='^', markersize='10', color='#0086a8', label=r'TauMinator - Endcap', zorder=2)
plt.yscale("log")
plt.ylim(bottom=1)
...
plt.figure(figsize=(12,12))
plt.plot(Xs_list[::3], singleTau_onlineRate_list[::3], lw=3, marker='o', markersize='10', color='#d04e00', label=r'TauMinator', zorder=0)
plt.plot(Xs_list[::3], singleTau_onlineRate_CB_list[::3], lw=3, marker='s', markersize='10', color='#f6c200', label=r'TauMinator - Barrel', zorder=1)
plt.plot(Xs_list[::3], singleTau_onlineRate_CE_list[::3], lw=3, marker='^', markersize='10', color='#0086a8', label=r'TauMinator - Endcap', zorder=2)
plt.yscale("log")
plt.ylim(bottom=1)
legend = plt.legend(loc = 'upper right', fontsize=20)
plt.grid(linestyle=':')
...
plt.figure(figsize=(12,12))
plt.plot(Xs_list[::3], diTau_offline90Rate_list[::3], lw=3, marker='o', markersize='10', color='#d04e00', label=r'TauMinator', zorder=0)
plt.plot(Xs_list[::3], diTau_offline90Rate_CB_list[::3], lw=3, marker='s', markersize='10', color='#f6c200', label=r'TauMinator - Barrel', zorder=1)
plt.plot(Xs_list[::3], diTau_offline90Rate_CE_list[::3], lw=3, marker='^', markersize='10', color='#0086a8', label=r'TauMinator - Endcap', zorder=2)
plt.yscale("log")
plt.ylim(bottom=1)
legend = plt.legend(loc = 'upper right', fontsize=20)
plt.grid(linestyle=':')
...
plt.figure(figsize=(12,12))
plt.plot(Xs_list[::3], singleTau_onlineRate_list[::3], lw=3, marker='o', markersize='10', color='#d04e00', label=r'Single-$\tau_{h}$ TauMinator', zorder=0)
plt.plot(Xs_list[::3], diTau_onlineRate_list[::3], lw=3, marker='o', markersize='10', color='#f6c200', label=r'Double-$\tau_{h}$ TauMinator', zorder=0)
plt.yscale("log")
plt.ylim(bottom=1)
legend = plt.legend(loc = 'upper right', fontsize=20)
plt.grid(linestyle=':')
...
plt.figure(figsize=(12,12))
plt.plot(Xs_list[::3], singleTau_offline90Rate_list[::3], lw=3, marker='o', markersize='10', color='#d04e00', label=r'Single-$\tau_{h}$ TauMinator', zorder=0)
plt.plot(Xs_list[::3], diTau_offline90Rate_list[::3], lw=3, marker='o', markersize='10', color='#f6c200', label=r'Double-$\tau_{h}$ TauMinator', zorder=0)
plt.yscale("log")
plt.ylim(bottom=1)
legend = plt.legend(loc = 'upper right', fontsize=20)
plt.grid(linestyle=':')
...
plt.xlim(10,175)
mplhep.cms.label('Phase-2 Simulation Preliminary', data=True, rlabel='14 TeV, 200 PU')
plt.savefig(perfdir+'/rate'+tag+'/DP_rate_diTau&singleTau_offline_CB'+WP_CB+'_CE'+WP_CE+'.pdf')
plt.close()
...
plt.figure(figsize=(12,12))
plt.plot(Xs_list[::3][:68], singleTau_offline90Rate_Tight[::3][:68], lw=3, marker='o', markersize='10', label=r'TauMinator', color="#d04e00", zorder=0)
...
plt.figure(figsize=(12,12))
plt.plot(Xs_list[::3][:68], singleTau_offline90Rate_CB_list[::3][:68], lw=3, marker='o', markersize='10', label=r'TauMinator - Barrel', color="#d04e00", zorder=4)
plt.plot(Xs_list[::3][:68], singleTau_offline90Rate_CE_list[::3][:68], lw=3, marker='o', markersize='10', label=r'TauMinator - Endcap', color="#132b69", zorder=4)
plt.plot(off['xs'], off['CaloTauBarrel'], lw=3, marker='^', markersize='10', label=r'Calo Tau - Barrel', color="#f6c200", zorder=2)
plt.plot(off['xs'], off['CaloTauEndcap'], lw=3, marker='^', markersize='10', label=r'Calo Tau - Endcap', color="#0086a8", zorder=2)
plt.yscale("log")
plt.ylim(bottom=1)
legend = plt.legend(loc = 'upper right', fontsize=20)
plt.grid(linestyle=':')
...
plt.xlim(80,200)
mplhep.cms.label('Phase-2 Simulation Preliminary', data=True, rlabel='14 TeV, 200 PU')
plt.savefig(perfdir+'/rate'+tag+'/DP_rate_singleTau_offline_comparison_tight_split.pdf')
plt.close()

plt.figure(figsize=(12,12))
plt.plot(Xs_list[::3][:68], singleTau_offline90Rate_Medium[::3][:68], lw=3, marker='o', markersize='10', label=r'TauMinator', color="#d04e00", zorder=0)
plt.plot(off['xs'], off['CaloTau'], lw=3, marker='^', markersize='10', label=r'Calo Tau', color="#0086a8", zorder=2)
plt.yscale("log")
plt.ylim(bottom=1)
legend = plt.legend(loc = 'upper right', fontsize=20)
...
plt.figure(figsize=(12,12))
plt.plot(Xs_list[::3][:68], singleTau_offline90Rate_Loose[::3][:68], lw=3, marker='o', markersize='10', label=r'TauMinator', color="#d04e00", zorder=0)
plt.plot(off['xs'], off['CaloTau'], lw=3, marker='^', markersize='10', label=r'Calo Tau', color="#0086a8", zorder=2)
plt.yscale("log")
plt.ylim(bottom=1)
legend = plt.legend(loc = 'upper right', fontsize=20)
...
plt.figure(figsize=(12,12))
plt.plot(Xs_list[::3][:68], singleTau_onlineRate_Tight[::3][:68], lw=3, marker='o', markersize='10', label=r'TauMinator', color="#d04e00", zorder=0)
...
plt.figure(figsize=(12,12))
plt.plot(Xs_list[::3][:68], singleTau_onlineRate_CB_list[::3][:68], lw=3, marker='o', markersize='10', label=r'TauMinator', color="#d04e00", zorder=0)
...
plt.figure(figsize=(12,12))
plt.plot(Xs_list[::3][:68], singleTau_onlineRate_CE_list[::3][:68], lw=3, marker='o', markersize='10', label=r'TauMinator', color="#d04e00", zorder=0)
...
plt.figure(figsize=(12,12))
plt.plot(Xs_list[::3][:68], singleTau_offline90Rate_CB_list[::3][:68], lw=3, marker='o', markersize='10', label=r'TauMinator', color="#d04e00", zorder=0)
...
plt.figure(figsize=(12,12))
plt.plot(Xs_list[::3][:68], singleTau_offline90Rate_CE_list[::3][:68], lw=3, marker='o', markersize='10', label=r'TauMinator', color="#d04e00", zorder=0)
