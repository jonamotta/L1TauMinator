...
if __name__ == "__main__" :
    ...
    full_valid_calib = fullCAL.predict(fullCNN([X1_valid, X2_valid, X3_valid])) #* 256.
    ...
    plt.grid(linestyle='dotted')
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(outdir+'/TauMinator_CE_calib'+tag+'_plots/predictions_comparison_vsFull.pdf')
    plt.close()
    ...
    plt.grid(linestyle='dotted')
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(outdir+'/TauMinator_CE_calib'+tag+'_plots/responses_comparison_vsFull.pdf')
    plt.close()
