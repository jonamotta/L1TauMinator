...
if __name__ == "__main__" :
    ...
    if options.loop:
        ...
        CB_CE_separation = options.CBCEsplit
        ...
        for evt in range(0, nEntries):
            ...
            for l1tauPt, l1tauEta, l1tauPhi, l1tauId in zizp(_l1tau_pt, _l1tau_eta, _l1tau_phi, _l1tau_IDscore):
                if abs(l1tauEta) > options.etaEr: continue # skip taus out of acceptance
                
                if abs(l1tauEta) < CB_CE_separation:
...
plt.plot(Xs_list, singleTau_onlineRate_list, linewidth=2, color='blue')
plt.yscale("log")
plt.ylim(bottom=1)
...
plt.savefig(perfdir+'/rate'+tag+'/rate_singleTau_online.pdf')
plt.close()

print('SingleTau Online Rate @ 25GeV :', np.interp(25, Xs_list, singleTau_onlineRate_list))
print('SingleTau Online Rate @ 50GeV :', np.interp(50, Xs_list, singleTau_onlineRate_list))
print('SingleTau Online Rate @ 75GeV :', np.interp(75, Xs_list, singleTau_onlineRate_list))
print('SingleTau Online Rate @ 100GeV :', np.interp(100, Xs_list, singleTau_onlineRate_list))
print('SingleTau Online Rate @ 125GeV :', np.interp(125, Xs_list, singleTau_onlineRate_list))
print('SingleTau Online Rate @ 150GeV :', np.interp(150, Xs_list, singleTau_onlineRate_list))
print('')
