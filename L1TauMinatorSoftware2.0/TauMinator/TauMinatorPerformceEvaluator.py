...
if __name__ == "__main__" :
    ...
    if options.loop:
        ...
        minated99_passing_ptBins_CB = []
        minated95_passing_ptBins_CB = []
        minated90_passing_ptBins_CB = []
        minated85_passing_ptBins_CB = []
        minated80_passing_ptBins_CB = []
        minated75_passing_ptBins_CB = []
        minated00_passing_ptBins_CE = []
        minated99_passing_ptBins_CE = []
        minated95_passing_ptBins_CE = []
        minated90_passing_ptBins_CE = []
        minated85_passing_ptBins_CE = []
        minated80_passing_ptBins_CE = []
        minated75_passing_ptBins_CE = []
        ...
        for threshold in online_thresholds:
            ...
            minated99_passing_ptBins_CB.append(ROOT.TH1F("minated99_passing_thr"+str(int(threshold))+"_ptBins_CB","minated99_passing_thr"+str(int(threshold))+"_ptBins_CB",len(ptBins)-1, array('f',ptBins)))
            minated95_passing_ptBins_CB.append(ROOT.TH1F("minated95_passing_thr"+str(int(threshold))+"_ptBins_CB","minated95_passing_thr"+str(int(threshold))+"_ptBins_CB",len(ptBins)-1, array('f',ptBins)))
            minated90_passing_ptBins_CB.append(ROOT.TH1F("minated90_passing_thr"+str(int(threshold))+"_ptBins_CB","minated90_passing_thr"+str(int(threshold))+"_ptBins_CB",len(ptBins)-1, array('f',ptBins)))
            minated85_passing_ptBins_CB.append(ROOT.TH1F("minated85_passing_thr"+str(int(threshold))+"_ptBins_CB","minated85_passing_thr"+str(int(threshold))+"_ptBins_CB",len(ptBins)-1, array('f',ptBins)))
            minated80_passing_ptBins_CB.append(ROOT.TH1F("minated80_passing_thr"+str(int(threshold))+"_ptBins_CB","minated80_passing_thr"+str(int(threshold))+"_ptBins_CB",len(ptBins)-1, array('f',ptBins)))
            minated75_passing_ptBins_CB.append(ROOT.TH1F("minated75_passing_thr"+str(int(threshold))+"_ptBins_CB","minated75_passing_thr"+str(int(threshold))+"_ptBins_CB",len(ptBins)-1, array('f',ptBins)))
            ...
            minated99_passing_ptBins_CE.append(ROOT.TH1F("minated99_passing_thr"+str(int(threshold))+"_ptBins_CE","minated99_passing_thr"+str(int(threshold))+"_ptBins_CE",len(ptBins)-1, array('f',ptBins)))
            minated95_passing_ptBins_CE.append(ROOT.TH1F("minated95_passing_thr"+str(int(threshold))+"_ptBins_CE","minated95_passing_thr"+str(int(threshold))+"_ptBins_CE",len(ptBins)-1, array('f',ptBins)))
            minated90_passing_ptBins_CE.append(ROOT.TH1F("minated90_passing_thr"+str(int(threshold))+"_ptBins_CE","minated90_passing_thr"+str(int(threshold))+"_ptBins_CE",len(ptBins)-1, array('f',ptBins)))
            minated85_passing_ptBins_CE.append(ROOT.TH1F("minated85_passing_thr"+str(int(threshold))+"_ptBins_CE","minated85_passing_thr"+str(int(threshold))+"_ptBins_CE",len(ptBins)-1, array('f',ptBins)))
            minated80_passing_ptBins_CE.append(ROOT.TH1F("minated80_passing_thr"+str(int(threshold))+"_ptBins_CE","minated80_passing_thr"+str(int(threshold))+"_ptBins_CE",len(ptBins)-1, array('f',ptBins)))
            minated75_passing_ptBins_CE.append(ROOT.TH1F("minated75_passing_thr"+str(int(threshold))+"_ptBins_CE","minated75_passing_thr"+str(int(threshold))+"_ptBins_CE",len(ptBins)-1, array('f',ptBins)))
        ...
        for evt in range(0, nEntries):
            ...
            for tauPt, tauEta, tauPhi in zip(_gentau_visPt, _gentau_visEta, _gentau_visPhi):
                ...
                for l1tauPt, l1tauEta, l1tauPhi, l1tauId in zip(_l1tau_pt, _l1tau_eta, _l1tau_phi, _l1tau_IDscore):
                    ...
                    # check matching
                    if gentau.DeltaR(l1tau)<0.3: #<0.5:
                ...
                for i, thr in enumerate(online_thresholds): 
                    if minatedMatched and highestMinatedL1Pt>float(thr):
                        ...
                        if abs(highestMinatedL1Eta)<1.5:
                            minated00_passing_ptBins[i].Fill(gentau.Pt())
                            if abs(gentau.Eta())<1.5: minated00_passing_ptBins_CB[i].Fill(gentau.Pt())

                            if highestMinatedL1Id >= idWp_CB['wp99']: # or highestMinatedL1Pt>75.: 
                                minated99_passing_ptBins[i].Fill(gentau.Pt())
                                if abs(gentau.Eta())<1.5: minated99_passing_ptBins_CB[i].Fill(gentau.Pt())
                            ...
                            if highestMinatedL1Id >= idWp_CB['wp95']: # or highestMinatedL1Pt>75.: 
                                ...
                                if abs(gentau.Eta())<1.5: minated95_passing_ptBins_CB[i].Fill(gentau.Pt())
                            ...
                            if highestMinatedL1Id >= idWp_CB['wp90']: # or highestMinatedL1Pt>75.: 
                                ...
                                if abs(gentau.Eta())<1.5: minated90_passing_ptBins_CB[i].Fill(gentau.Pt())
                            ...
                            if highestMinatedL1Id >= idWp_CB['wp85']: # or highestMinatedL1Pt>75.: 
                                ...
                                if abs(gentau.Eta())<1.5: minated85_passing_ptBins_CB[i].Fill(gentau.Pt())

                            if highestMinatedL1Id >= idWp_CB['wp80']: # or highestMinatedL1Pt>75.: 
                                minated80_passing_ptBins[i].Fill(gentau.Pt())
                                if abs(gentau.Eta())<1.5: minated80_passing_ptBins_CB[i].Fill(gentau.Pt())

                            if highestMinatedL1Id >= idWp_CB['wp75']: # or highestMinatedL1Pt>75.: 
                                minated75_passing_ptBins[i].Fill(gentau.Pt())
                                if abs(gentau.Eta())<1.5: minated75_passing_ptBins_CB[i].Fill(gentau.Pt())
                        else:
                            minated00_passing_ptBins[i].Fill(gentau.Pt())
                            if abs(gentau.Eta())>1.5: minated00_passing_ptBins_CE[i].Fill(gentau.Pt())

                            if highestMinatedL1Id >= idWp_CE['wp99']: # or highestMinatedL1Pt>75.: 
                                minated99_passing_ptBins[i].Fill(gentau.Pt())
                                if abs(gentau.Eta())>1.5: minated99_passing_ptBins_CE[i].Fill(gentau.Pt())
                                if gentau.Pt() > 40: minated99_passing_etaBins[i].Fill(gentau.Eta())
                            
                            if highestMinatedL1Id >= idWp_CE['wp95']: # or highestMinatedL1Pt>75.: 
                                minated95_passing_ptBins[i].Fill(gentau.Pt())
                                if abs(gentau.Eta())>1.5: minated95_passing_ptBins_CE[i].Fill(gentau.Pt())
                                if gentau.Pt() > 40: minated95_passing_etaBins[i].Fill(gentau.Eta())
                            
                            if highestMinatedL1Id >= idWp_CE['wp90']: # or highestMinatedL1Pt>75.: 
                                minated90_passing_ptBins[i].Fill(gentau.Pt())
                                if abs(gentau.Eta())>1.5: minated90_passing_ptBins_CE[i].Fill(gentau.Pt())
                                if gentau.Pt() > 40: minated90_passing_etaBins[i].Fill(gentau.Eta())

                            if highestMinatedL1Id >= idWp_CE['wp85']: # or highestMinatedL1Pt>75.: 
                                minated85_passing_ptBins[i].Fill(gentau.Pt())
                                if abs(gentau.Eta())>1.5: minated85_passing_ptBins_CE[i].Fill(gentau.Pt())

                            if highestMinatedL1Id >= idWp_CE['wp80']: # or highestMinatedL1Pt>75.: 
                                minated80_passing_ptBins[i].Fill(gentau.Pt())
                                if abs(gentau.Eta())>1.5: minated80_passing_ptBins_CE[i].Fill(gentau.Pt())

                            if highestMinatedL1Id >= idWp_CE['wp75']: # or highestMinatedL1Pt>75.: 
                                minated75_passing_ptBins[i].Fill(gentau.Pt())
                                if abs(gentau.Eta())>1.5: minated75_passing_ptBins_CE[i].Fill(gentau.Pt())
        ...
        for i, thr in enumerate(online_thresholds):
            ...
            turnonsMinated99_CB.append(ROOT.TGraphAsymmErrors(minated99_passing_ptBins_CB[i], denominator_ptBins_CB, "cp"))
            turnonsMinated95_CB.append(ROOT.TGraphAsymmErrors(minated95_passing_ptBins_CB[i], denominator_ptBins_CB, "cp"))
            turnonsMinated90_CB.append(ROOT.TGraphAsymmErrors(minated90_passing_ptBins_CB[i], denominator_ptBins_CB, "cp"))
            turnonsMinated85_CB.append(ROOT.TGraphAsymmErrors(minated85_passing_ptBins_CB[i], denominator_ptBins_CB, "cp"))
            turnonsMinated80_CB.append(ROOT.TGraphAsymmErrors(minated80_passing_ptBins_CB[i], denominator_ptBins_CB, "cp"))
            turnonsMinated75_CB.append(ROOT.TGraphAsymmErrors(minated75_passing_ptBins_CB[i], denominator_ptBins_CB, "cp"))

            turnonsMinated00_CE.append(ROOT.TGraphAsymmErrors(minated00_passing_ptBins_CE[i], denominator_ptBins_CE, "cp"))
            turnonsMinated99_CE.append(ROOT.TGraphAsymmErrors(minated99_passing_ptBins_CE[i], denominator_ptBins_CE, "cp"))
            turnonsMinated95_CE.append(ROOT.TGraphAsymmErrors(minated95_passing_ptBins_CE[i], denominator_ptBins_CE, "cp"))
            turnonsMinated90_CE.append(ROOT.TGraphAsymmErrors(minated90_passing_ptBins_CE[i], denominator_ptBins_CE, "cp"))
            turnonsMinated85_CE.append(ROOT.TGraphAsymmErrors(minated85_passing_ptBins_CE[i], denominator_ptBins_CE, "cp"))
            turnonsMinated80_CE.append(ROOT.TGraphAsymmErrors(minated80_passing_ptBins_CE[i], denominator_ptBins_CE, "cp"))
            turnonsMinated75_CE.append(ROOT.TGraphAsymmErrors(minated75_passing_ptBins_CE[i], denominator_ptBins_CE, "cp"))
        ...
        for i, thr in enumerate(online_thresholds): 
            ...
            minated99_passing_ptBins_CB[i].Write()
            minated95_passing_ptBins_CB[i].Write()
            minated90_passing_ptBins_CB[i].Write()
            minated85_passing_ptBins_CB[i].Write()
            minated80_passing_ptBins_CB[i].Write()
            minated75_passing_ptBins_CB[i].Write()
            minated00_passing_ptBins_CE[i].Write()
            minated99_passing_ptBins_CE[i].Write()
            minated95_passing_ptBins_CE[i].Write()
            minated90_passing_ptBins_CE[i].Write()
            minated85_passing_ptBins_CE[i].Write()
            minated80_passing_ptBins_CE[i].Write()
            minated75_passing_ptBins_CE[i].Write()
            ...
            turnonsMinated99_CB[i].Write()
            turnonsMinated95_CB[i].Write()
            turnonsMinated90_CB[i].Write()
            turnonsMinated85_CB[i].Write()
            turnonsMinated80_CB[i].Write()
            turnonsMinated75_CB[i].Write()
            turnonsMinated00_CE[i].Write()
            turnonsMinated99_CE[i].Write()
            turnonsMinated95_CE[i].Write()
            turnonsMinated90_CE[i].Write()
            turnonsMinated85_CE[i].Write()
            turnonsMinated80_CE[i].Write()
            turnonsMinated75_CE[i].Write()
        ...
        for i, thr in enumerate(online_thresholds):
            ...
            turnonsMinated99_CB.append(filein.Get("divide_minated99_passing_thr"+str(int(thr))+"_ptBins_CB_by_denominator_ptBins_CB"))
            turnonsMinated95_CB.append(filein.Get("divide_minated95_passing_thr"+str(int(thr))+"_ptBins_CB_by_denominator_ptBins_CB"))
            turnonsMinated90_CB.append(filein.Get("divide_minated90_passing_thr"+str(int(thr))+"_ptBins_CB_by_denominator_ptBins_CB"))
            turnonsMinated85_CB.append(filein.Get("divide_minated85_passing_thr"+str(int(thr))+"_ptBins_CB_by_denominator_ptBins_CB"))
            turnonsMinated80_CB.append(filein.Get("divide_minated80_passing_thr"+str(int(thr))+"_ptBins_CB_by_denominator_ptBins_CB"))
            turnonsMinated75_CB.append(filein.Get("divide_minated75_passing_thr"+str(int(thr))+"_ptBins_CB_by_denominator_ptBins_CB"))
            turnonsMinated00_CE.append(filein.Get("divide_minated00_passing_thr"+str(int(thr))+"_ptBins_CE_by_denominator_ptBins_CE"))
            turnonsMinated99_CE.append(filein.Get("divide_minated99_passing_thr"+str(int(thr))+"_ptBins_CE_by_denominator_ptBins_CE"))
            turnonsMinated95_CE.append(filein.Get("divide_minated95_passing_thr"+str(int(thr))+"_ptBins_CE_by_denominator_ptBins_CE"))
            turnonsMinated90_CE.append(filein.Get("divide_minated90_passing_thr"+str(int(thr))+"_ptBins_CE_by_denominator_ptBins_CE"))
            turnonsMinated85_CE.append(filein.Get("divide_minated85_passing_thr"+str(int(thr))+"_ptBins_CE_by_denominator_ptBins_CE"))
            turnonsMinated80_CE.append(filein.Get("divide_minated80_passing_thr"+str(int(thr))+"_ptBins_CE_by_denominator_ptBins_CE"))
            turnonsMinated75_CE.append(filein.Get("divide_minated75_passing_thr"+str(int(thr))+"_ptBins_CE_by_denominator_ptBins_CE"))
    ...
    for i, thr in enumerate(online_thresholds):
        ...
        turnons_dict_CB['turnonAt99wpAt'+str(thr)+'GeV'] = [[],[],[]]
        turnons_dict_CB['turnonAt95wpAt'+str(thr)+'GeV'] = [[],[],[]]
        turnons_dict_CB['turnonAt90wpAt'+str(thr)+'GeV'] = [[],[],[]]
        turnons_dict_CB['turnonAt85wpAt'+str(thr)+'GeV'] = [[],[],[]]
        turnons_dict_CB['turnonAt80wpAt'+str(thr)+'GeV'] = [[],[],[]]
        turnons_dict_CB['turnonAt75wpAt'+str(thr)+'GeV'] = [[],[],[]]

        turnons_dict_CE['turnonAt00wpAt'+str(thr)+'GeV'] = [[],[],[]]
        turnons_dict_CE['turnonAt99wpAt'+str(thr)+'GeV'] = [[],[],[]]
        turnons_dict_CE['turnonAt95wpAt'+str(thr)+'GeV'] = [[],[],[]]
        turnons_dict_CE['turnonAt90wpAt'+str(thr)+'GeV'] = [[],[],[]]
        turnons_dict_CE['turnonAt85wpAt'+str(thr)+'GeV'] = [[],[],[]]
        turnons_dict_CE['turnonAt80wpAt'+str(thr)+'GeV'] = [[],[],[]]
        turnons_dict_CE['turnonAt75wpAt'+str(thr)+'GeV'] = [[],[],[]]
        ...
        for ibin in range(0,turnonsMinated99[i].GetN()):
            ...
            turnons_dict_CB['turnonAt99wpAt'+str(thr)+'GeV'][0].append(turnonsMinated99_CB[i].GetPointY(ibin))
            turnons_dict_CB['turnonAt95wpAt'+str(thr)+'GeV'][0].append(turnonsMinated95_CB[i].GetPointY(ibin))
            turnons_dict_CB['turnonAt90wpAt'+str(thr)+'GeV'][0].append(turnonsMinated90_CB[i].GetPointY(ibin))
            turnons_dict_CB['turnonAt85wpAt'+str(thr)+'GeV'][0].append(turnonsMinated85_CB[i].GetPointY(ibin))
            turnons_dict_CB['turnonAt80wpAt'+str(thr)+'GeV'][0].append(turnonsMinated80_CB[i].GetPointY(ibin))
            turnons_dict_CB['turnonAt75wpAt'+str(thr)+'GeV'][0].append(turnonsMinated75_CB[i].GetPointY(ibin))

            turnons_dict_CB['turnonAt00wpAt'+str(thr)+'GeV'][1].append(turnonsMinated00_CB[i].GetErrorYlow(ibin))
            turnons_dict_CB['turnonAt99wpAt'+str(thr)+'GeV'][1].append(turnonsMinated99_CB[i].GetErrorYlow(ibin))
            turnons_dict_CB['turnonAt95wpAt'+str(thr)+'GeV'][1].append(turnonsMinated95_CB[i].GetErrorYlow(ibin))
            turnons_dict_CB['turnonAt90wpAt'+str(thr)+'GeV'][1].append(turnonsMinated90_CB[i].GetErrorYlow(ibin))
            turnons_dict_CB['turnonAt85wpAt'+str(thr)+'GeV'][1].append(turnonsMinated85_CB[i].GetErrorYlow(ibin))
            turnons_dict_CB['turnonAt80wpAt'+str(thr)+'GeV'][1].append(turnonsMinated80_CB[i].GetErrorYlow(ibin))
            turnons_dict_CB['turnonAt75wpAt'+str(thr)+'GeV'][1].append(turnonsMinated75_CB[i].GetErrorYlow(ibin))

            turnons_dict_CB['turnonAt00wpAt'+str(thr)+'GeV'][2].append(turnonsMinated00_CB[i].GetErrorYhigh(ibin))
            turnons_dict_CB['turnonAt99wpAt'+str(thr)+'GeV'][2].append(turnonsMinated99_CB[i].GetErrorYhigh(ibin))
            turnons_dict_CB['turnonAt95wpAt'+str(thr)+'GeV'][2].append(turnonsMinated95_CB[i].GetErrorYhigh(ibin))
            turnons_dict_CB['turnonAt90wpAt'+str(thr)+'GeV'][2].append(turnonsMinated90_CB[i].GetErrorYhigh(ibin))
            turnons_dict_CB['turnonAt85wpAt'+str(thr)+'GeV'][2].append(turnonsMinated85_CB[i].GetErrorYhigh(ibin))
            turnons_dict_CB['turnonAt80wpAt'+str(thr)+'GeV'][2].append(turnonsMinated80_CB[i].GetErrorYhigh(ibin))
            turnons_dict_CB['turnonAt75wpAt'+str(thr)+'GeV'][2].append(turnonsMinated75_CB[i].GetErrorYhigh(ibin))

            turnons_dict_CE['turnonAt00wpAt'+str(thr)+'GeV'][0].append(turnonsMinated00_CE[i].GetPointY(ibin))
            turnons_dict_CE['turnonAt99wpAt'+str(thr)+'GeV'][0].append(turnonsMinated99_CE[i].GetPointY(ibin))
            turnons_dict_CE['turnonAt95wpAt'+str(thr)+'GeV'][0].append(turnonsMinated95_CE[i].GetPointY(ibin))
            turnons_dict_CE['turnonAt90wpAt'+str(thr)+'GeV'][0].append(turnonsMinated90_CE[i].GetPointY(ibin))
            turnons_dict_CE['turnonAt85wpAt'+str(thr)+'GeV'][0].append(turnonsMinated85_CE[i].GetPointY(ibin))
            turnons_dict_CE['turnonAt80wpAt'+str(thr)+'GeV'][0].append(turnonsMinated80_CE[i].GetPointY(ibin))
            turnons_dict_CE['turnonAt75wpAt'+str(thr)+'GeV'][0].append(turnonsMinated75_CE[i].GetPointY(ibin))

            turnons_dict_CE['turnonAt00wpAt'+str(thr)+'GeV'][1].append(turnonsMinated00_CE[i].GetErrorYlow(ibin))
            turnons_dict_CE['turnonAt99wpAt'+str(thr)+'GeV'][1].append(turnonsMinated99_CE[i].GetErrorYlow(ibin))
            turnons_dict_CE['turnonAt95wpAt'+str(thr)+'GeV'][1].append(turnonsMinated95_CE[i].GetErrorYlow(ibin))
            turnons_dict_CE['turnonAt90wpAt'+str(thr)+'GeV'][1].append(turnonsMinated90_CE[i].GetErrorYlow(ibin))
            turnons_dict_CE['turnonAt85wpAt'+str(thr)+'GeV'][1].append(turnonsMinated85_CE[i].GetErrorYlow(ibin))
            turnons_dict_CE['turnonAt80wpAt'+str(thr)+'GeV'][1].append(turnonsMinated80_CE[i].GetErrorYlow(ibin))
            turnons_dict_CE['turnonAt75wpAt'+str(thr)+'GeV'][1].append(turnonsMinated75_CE[i].GetErrorYlow(ibin))

            turnons_dict_CE['turnonAt00wpAt'+str(thr)+'GeV'][2].append(turnonsMinated00_CE[i].GetErrorYhigh(ibin))
            turnons_dict_CE['turnonAt99wpAt'+str(thr)+'GeV'][2].append(turnonsMinated99_CE[i].GetErrorYhigh(ibin))
            turnons_dict_CE['turnonAt95wpAt'+str(thr)+'GeV'][2].append(turnonsMinated95_CE[i].GetErrorYhigh(ibin))
            turnons_dict_CE['turnonAt90wpAt'+str(thr)+'GeV'][2].append(turnonsMinated90_CE[i].GetErrorYhigh(ibin))
            turnons_dict_CE['turnonAt85wpAt'+str(thr)+'GeV'][2].append(turnonsMinated85_CE[i].GetErrorYhigh(ibin))
            turnons_dict_CE['turnonAt80wpAt'+str(thr)+'GeV'][2].append(turnonsMinated80_CE[i].GetErrorYhigh(ibin))
            turnons_dict_CE['turnonAt75wpAt'+str(thr)+'GeV'][2].append(turnonsMinated75_CE[i].GetErrorYhigh(ibin))
    ...
    plt.figure(figsize=(10,10))
    thr=0
    plt.errorbar(offline_pts,turnons_dict_CB['turnonAt90wpAt'+str(thr)+'GeV'][0],xerr=1,yerr=[turnons_dict_CB['turnonAt90wpAt'+str(thr)+'GeV'][1], turnons_dict_CB['turnonAt90wpAt'+str(thr)+'GeV'][2]], ls='-', label=r'CB - $p_{T}^{L1 \tau} > %i$ GeV' % (thr), lw=2, marker='o', color='green')
    plt.errorbar(offline_pts,turnons_dict_CE['turnonAt90wpAt'+str(thr)+'GeV'][0],xerr=1,yerr=[turnons_dict_CE['turnonAt90wpAt'+str(thr)+'GeV'][1], turnons_dict_CE['turnonAt90wpAt'+str(thr)+'GeV'][2]], ls='-', label=r'CE - $p_{T}^{L1 \tau} > %i$ GeV' % (thr), lw=2, marker='o', color='red')
    plt.hlines(0.90, 0, 2000, lw=2, color='dimgray', label='0.90 Eff.')
    plt.hlines(0.95, 0, 2000, lw=2, color='black', label='0.95 Eff.')
    plt.legend(loc = 'lower right', fontsize=14)
    plt.ylim(0., 1.05)
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_Emyr.pdf')
    plt.close()
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP00.pdf')
    plt.close()
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP00_CB.pdf')
    plt.close()
    ...
    for thr in plotting_thresholds:
        if not thr%10:
            plt.errorbar(offline_pts,turnons_dict_CB['turnonAt99wpAt'+str(thr)+'GeV'][0],xerr=1,yerr=[turnons_dict_CB['turnonAt99wpAt'+str(thr)+'GeV'][1], turnons_dict_CB['turnonAt99wpAt'+str(thr)+'GeV'][2]], ls='None', label=r'$p_{T}^{L1 \tau} > %i$ GeV' % (thr), lw=2, marker='o', color=cmap(i))

            p0 = [1, thr, 1] 
            popt, pcov = curve_fit(sigmoid, offline_pts, turnons_dict_CB['turnonAt99wpAt'+str(thr)+'GeV'][0], p0, maxfev=5000)
            plt.plot(offline_pts, sigmoid(offline_pts, *popt), '-', label='_', lw=1.5, color=cmap(i))
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP99_CB.pdf')
    plt.close()
    ...
    for thr in plotting_thresholds:
        if not thr%10:
            plt.errorbar(offline_pts,turnons_dict_CB['turnonAt95wpAt'+str(thr)+'GeV'][0],xerr=1,yerr=[turnons_dict_CB['turnonAt95wpAt'+str(thr)+'GeV'][1], turnons_dict_CB['turnonAt95wpAt'+str(thr)+'GeV'][2]], ls='None', label=r'$p_{T}^{L1 \tau} > %i$ GeV' % (thr), lw=2, marker='o', color=cmap(i))

            p0 = [1, thr, 1] 
            popt, pcov = curve_fit(sigmoid, offline_pts, turnons_dict_CB['turnonAt95wpAt'+str(thr)+'GeV'][0], p0, maxfev=5000)
            plt.plot(offline_pts, sigmoid(offline_pts, *popt), '-', label='_', lw=1.5, color=cmap(i))
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP95_CB.pdf')
    plt.close()
    ...
    for thr in plotting_thresholds:
        if not thr%10:
            plt.errorbar(offline_pts,turnons_dict_CB['turnonAt90wpAt'+str(thr)+'GeV'][0],xerr=1,yerr=[turnons_dict_CB['turnonAt90wpAt'+str(thr)+'GeV'][1], turnons_dict_CB['turnonAt90wpAt'+str(thr)+'GeV'][2]], ls='None', label=r'$p_{T}^{L1 \tau} > %i$ GeV' % (thr), lw=2, marker='o', color=cmap(i))

            p0 = [1, thr, 1] 
            popt, pcov = curve_fit(sigmoid, offline_pts, turnons_dict_CB['turnonAt90wpAt'+str(thr)+'GeV'][0], p0, maxfev=5000)
            plt.plot(offline_pts, sigmoid(offline_pts, *popt), '-', label='_', lw=1.5, color=cmap(i))
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP90_CB.pdf')
    plt.close()
    ...
    for thr in plotting_thresholds:
        if not thr%10:
            plt.errorbar(offline_pts,turnons_dict_CB['turnonAt85wpAt'+str(thr)+'GeV'][0],xerr=1,yerr=[turnons_dict_CB['turnonAt85wpAt'+str(thr)+'GeV'][1], turnons_dict_CB['turnonAt85wpAt'+str(thr)+'GeV'][2]], ls='None', label=r'$p_{T}^{L1 \tau} > %i$ GeV' % (thr), lw=2, marker='o', color=cmap(i))

            p0 = [1, thr, 1] 
            popt, pcov = curve_fit(sigmoid, offline_pts, turnons_dict_CB['turnonAt85wpAt'+str(thr)+'GeV'][0], p0, maxfev=5000)
            plt.plot(offline_pts, sigmoid(offline_pts, *popt), '-', label='_', lw=1.5, color=cmap(i))
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP85_CB.pdf')
    plt.close()
    ...
    for thr in plotting_thresholds:
        if not thr%10:
            plt.errorbar(offline_pts,turnons_dict_CB['turnonAt80wpAt'+str(thr)+'GeV'][0],xerr=1,yerr=[turnons_dict_CB['turnonAt80wpAt'+str(thr)+'GeV'][1], turnons_dict_CB['turnonAt80wpAt'+str(thr)+'GeV'][2]], ls='None', label=r'$p_{T}^{L1 \tau} > %i$ GeV' % (thr), lw=2, marker='o', color=cmap(i))

            p0 = [1, thr, 1] 
            popt, pcov = curve_fit(sigmoid, offline_pts, turnons_dict_CB['turnonAt80wpAt'+str(thr)+'GeV'][0], p0, maxfev=5000)
            plt.plot(offline_pts, sigmoid(offline_pts, *popt), '-', label='_', lw=1.5, color=cmap(i))
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP80_CB.pdf')
    plt.close()
    ...
    for thr in plotting_thresholds:
        if not thr%10:
            plt.errorbar(offline_pts,turnons_dict_CB['turnonAt75wpAt'+str(thr)+'GeV'][0],xerr=1,yerr=[turnons_dict_CB['turnonAt75wpAt'+str(thr)+'GeV'][1], turnons_dict_CB['turnonAt75wpAt'+str(thr)+'GeV'][2]], ls='None', label=r'$p_{T}^{L1 \tau} > %i$ GeV' % (thr), lw=2, marker='o', color=cmap(i))

            p0 = [1, thr, 1] 
            popt, pcov = curve_fit(sigmoid, offline_pts, turnons_dict_CB['turnonAt75wpAt'+str(thr)+'GeV'][0], p0, maxfev=5000)
            plt.plot(offline_pts, sigmoid(offline_pts, *popt), '-', label='_', lw=1.5, color=cmap(i))
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP75_CB.pdf')
    plt.close()
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP00_CE.pdf')
    plt.close()
    ...
    for thr in plotting_thresholds:
        if not thr%10:
            plt.errorbar(offline_pts,turnons_dict_CE['turnonAt99wpAt'+str(thr)+'GeV'][0],xerr=1,yerr=[turnons_dict_CE['turnonAt99wpAt'+str(thr)+'GeV'][1], turnons_dict_CE['turnonAt99wpAt'+str(thr)+'GeV'][2]], ls='None', label=r'$p_{T}^{L1 \tau} > %i$ GeV' % (thr), lw=2, marker='o', color=cmap(i))

            p0 = [1, thr, 1] 
            popt, pcov = curve_fit(sigmoid, offline_pts, turnons_dict_CE['turnonAt99wpAt'+str(thr)+'GeV'][0], p0, maxfev=5000)
            plt.plot(offline_pts, sigmoid(offline_pts, *popt), '-', label='_', lw=1.5, color=cmap(i))
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP99_CE.pdf')
    plt.close()
    ...
    for thr in plotting_thresholds:
        if not thr%10:
            plt.errorbar(offline_pts,turnons_dict_CE['turnonAt95wpAt'+str(thr)+'GeV'][0],xerr=1,yerr=[turnons_dict_CE['turnonAt95wpAt'+str(thr)+'GeV'][1], turnons_dict_CE['turnonAt95wpAt'+str(thr)+'GeV'][2]], ls='None', label=r'$p_{T}^{L1 \tau} > %i$ GeV' % (thr), lw=2, marker='o', color=cmap(i))

            p0 = [1, thr, 1] 
            popt, pcov = curve_fit(sigmoid, offline_pts, turnons_dict_CE['turnonAt95wpAt'+str(thr)+'GeV'][0], p0, maxfev=5000)
            plt.plot(offline_pts, sigmoid(offline_pts, *popt), '-', label='_', lw=1.5, color=cmap(i))
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP95_CE.pdf')
    plt.close()
    ...
    for thr in plotting_thresholds:
        if not thr%10:
            plt.errorbar(offline_pts,turnons_dict_CE['turnonAt90wpAt'+str(thr)+'GeV'][0],xerr=1,yerr=[turnons_dict_CE['turnonAt90wpAt'+str(thr)+'GeV'][1], turnons_dict_CE['turnonAt90wpAt'+str(thr)+'GeV'][2]], ls='None', label=r'$p_{T}^{L1 \tau} > %i$ GeV' % (thr), lw=2, marker='o', color=cmap(i))

            p0 = [1, thr, 1] 
            popt, pcov = curve_fit(sigmoid, offline_pts, turnons_dict_CE['turnonAt90wpAt'+str(thr)+'GeV'][0], p0, maxfev=5000)
            plt.plot(offline_pts, sigmoid(offline_pts, *popt), '-', label='_', lw=1.5, color=cmap(i))
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP90_CE.pdf')
    plt.close()
    ...
    for thr in plotting_thresholds:
        if not thr%10:
            plt.errorbar(offline_pts,turnons_dict_CE['turnonAt85wpAt'+str(thr)+'GeV'][0],xerr=1,yerr=[turnons_dict_CE['turnonAt85wpAt'+str(thr)+'GeV'][1], turnons_dict_CE['turnonAt85wpAt'+str(thr)+'GeV'][2]], ls='None', label=r'$p_{T}^{L1 \tau} > %i$ GeV' % (thr), lw=2, marker='o', color=cmap(i))

            p0 = [1, thr, 1] 
            popt, pcov = curve_fit(sigmoid, offline_pts, turnons_dict_CE['turnonAt85wpAt'+str(thr)+'GeV'][0], p0, maxfev=5000)
            plt.plot(offline_pts, sigmoid(offline_pts, *popt), '-', label='_', lw=1.5, color=cmap(i))
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP85_CE.pdf')
    plt.close()
    ...
    for thr in plotting_thresholds:
        if not thr%10:
            plt.errorbar(offline_pts,turnons_dict_CE['turnonAt80wpAt'+str(thr)+'GeV'][0],xerr=1,yerr=[turnons_dict_CE['turnonAt80wpAt'+str(thr)+'GeV'][1], turnons_dict_CE['turnonAt80wpAt'+str(thr)+'GeV'][2]], ls='None', label=r'$p_{T}^{L1 \tau} > %i$ GeV' % (thr), lw=2, marker='o', color=cmap(i))

            p0 = [1, thr, 1] 
            popt, pcov = curve_fit(sigmoid, offline_pts, turnons_dict_CE['turnonAt80wpAt'+str(thr)+'GeV'][0], p0, maxfev=5000)
            plt.plot(offline_pts, sigmoid(offline_pts, *popt), '-', label='_', lw=1.5, color=cmap(i))
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP80_CE.pdf')
    plt.close()
    ...
    for thr in plotting_thresholds:
        if not thr%10:
            plt.errorbar(offline_pts,turnons_dict_CE['turnonAt75wpAt'+str(thr)+'GeV'][0],xerr=1,yerr=[turnons_dict_CE['turnonAt75wpAt'+str(thr)+'GeV'][1], turnons_dict_CE['turnonAt75wpAt'+str(thr)+'GeV'][2]], ls='None', label=r'$p_{T}^{L1 \tau} > %i$ GeV' % (thr), lw=2, marker='o', color=cmap(i))

            p0 = [1, thr, 1] 
            popt, pcov = curve_fit(sigmoid, offline_pts, turnons_dict_CE['turnonAt75wpAt'+str(thr)+'GeV'][0], p0, maxfev=5000)
            plt.plot(offline_pts, sigmoid(offline_pts, *popt), '-', label='_', lw=1.5, color=cmap(i))
    ...
    plt.grid()
    mplhep.cms.label('Phase-2 Simulation', data=True, rlabel='14 TeV, 200 PU')
    plt.savefig(perfdir+'/turnons'+tag+'/turnons_WP75_CE.pdf')
    plt.close()
