...
if __name__ == "__main__" :
    ...
    if options.doMinBias:
        ...
        tmp = indir+'/tmpRate__batches/TensorizedInputs_'+options.caloClNxM+options.inTag
        indirs.append(tmp)
    ...
    if options.doTens4Calib:
        ...
        np.savez_compressed(indir+'/TauCNNEvaluator'+options.caloClNxM+options.outTag+'/X_Rate_CNN_'+options.caloClNxM+'_forEvaluator.npz', X1)
        np.savez_compressed(indir+'/TauCNNEvaluator'+options.caloClNxM+options.outTag+'/X_Rate_Dense_'+options.caloClNxM+'_forEvaluator.npz', X2)
        np.savez_compressed(indir+'/TauCNNEvaluator'+options.caloClNxM+options.outTag+'/Y_Rate_'+options.caloClNxM+'_forEvaluator.npz', Y)
